    ...
    transformer: {
      logo: {
        ...
        fromRaw(image, rawResource) {
          ...
          return isAbsolute
            ? logo
            : `http://market.zetsoft.uz/uploaz/market/ShopBrand/${this.rawField}/${rawResource.id}/${logo}`;
        },
    ...
    transformer: {
      ...
      image: {
        ...
        fromRaw(image, rawResource) {
          ...
          return isAbsolute
            ? logo
            : `http://market.zetsoft.uz/uploaz/market/ShopCategory/${this.rawField}/${rawResource.id}/${logo}`;
        },
    ...
    transformer: {
      logo: {
        ...
        fromRaw(photo, rawResource) {
          ...
          return isAbsolute
            ? logo
            : `http://market.zetsoft.uz/uploaz/market/UserCompany/photo/${rawResource.id}/${logo}`;
        },
